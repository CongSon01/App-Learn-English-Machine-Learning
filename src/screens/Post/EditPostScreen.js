            ...
            <React.Fragment>
                <Animated.ScrollView>
                    ...
                    <View style={styles.headerInformation}>
                        ...
                        <View style={styles.nameView}><Text style={styles.nameText}>Dương Công Sơn</Text></View>   
                    </View>
                    <View>
                    <TextInput
                        multiline={true}
                        numberOfLines={4}
                        style={{ color: colors.white , fontSize:20, height:100, textAlignVertical: 'top', paddingLeft: 10}}
                ...
                <View style={[styles.footer, {position: 'absolute', bottom: bottomOffset}]}>
                    <View>
                        <Ionicons name="images-outline" size="30" color={colors.white} style={styles.iconFooter} onPress={() => handleUploadImage()}></Ionicons>
                    </View>
                    <View>
                        <Ionicons name={isPublic ? "lock-open-outline" : "lock-closed-outline"} size="30" color={colors.white} style={styles.iconFooter} onPress={() => handleChangePublic()}></Ionicons>
                    </View>
                    <View>
                        {labelCate === "" ? 
                        <Ionicons name="folder-open-outline" size="30" color={colors.white} style={styles.iconFooter} onPress={() => handleChangeCate()}></Ionicons>
                         : 
