        ...
        <View style={gStyle.container}>
            ...
            <React.Fragment>
                    ...
                    <View style={styles.containerVocab}>
                        <Text style={styles.textLarge}>Bạn có {userVocabs.length} từ vựng</Text>
                        <Text style={styles.textSmall}>Nhấn vào để xem nghĩa</Text>
                        ...
                        <View>
                            ...
                            <Text style={styles.textSmall}>0/{userVocabs.length} Từ vựng đã học</Text>
                    ...
                    <Pressable style={styles.footer} onPress={() => navigation.navigate('CardQuiz', {userVocabs: userVocabs})}>
                        <Text style={styles.textLarge}>Học từ vựng</Text>
                    </Pressable>
            </React.Fragment> 
        </View>
    );
