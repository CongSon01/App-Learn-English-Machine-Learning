        ...
        >
          ...
          <View style={styles.listStyle}>
            <LinearGradient colors={['#93C6F9', '#97B4FA', '#A768FE']}
              ...
              <Text style={styles.textVip}>Gói VIP/Magazine 1 năm (đ1.799.000)</Text>
              <Text style={styles.textVipSmall}>Gói VIP/Magazine 1 năm (đ1.799.000)</Text>
            </LinearGradient>
            <LinearGradient colors={['#93C6F9', '#97B4FA', '#A768FE']}
                            start={[0, 0]}
                            end={[1, 1]}
