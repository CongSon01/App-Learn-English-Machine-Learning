      ...
      <View style={styles.containerFixed}>
        ...
        <View style={styles.containerCateLesson}>
          <Text style={styles.cateLessonInfo}>
            Group7-Ielts ứng dụng học Ielts hàng đầu Việt Nam
          </Text>
        </View>
      </View>
        ...
        <View style={styles.containerLessons}>
            <View style={styles.container}>
                <View style={gStyle.flexRow}>
                    <Text style={styles.title_label}>Xin chào: </Text>
            ...
            <View style={styles.container}>
                <View style={gStyle.flex1}>
                    <Text style={styles.title_content}>Email người dùng</Text>
            ...
            {/* <View style={styles.container}>
                <View style={gStyle.flex1}>
                    ...
                    <TextInput secureTextEntry={true} style={styles.input} value="son167464@huce.edu.vn" placeholderTextColor="#b6b6b6" ></TextInput>
                </View>
            </View> */}
            <View style={styles.container}>
